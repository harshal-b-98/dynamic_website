...
export interface SocialLink {
  platform: 'facebook' | 'twitter' | 'instagram' | 'linkedin' | 'github' | 'youtube' | 'tiktok' | 'discord' | 'email'
  url: string
  label?: string
}
...
export const SocialLinks: React.FC<SocialLinksProps> = ({
  ...
  const getVariantClasses = (platform: string): string => {
    const colorMap: Record<string, string> = {
      ...
      tiktok: 'bg-black hover:bg-gray-900 dark:bg-gray-900 dark:hover:bg-gray-800',
      discord: 'bg-indigo-600 hover:bg-indigo-700',
      email: 'bg-gray-600 hover:bg-gray-700'
    }

    if (variant === 'colored') {
      return `${colorMap[platform] || 'bg-gray-600 hover:bg-gray-700'} text-white`
    }

    if (variant === 'outline') {
      return 'border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
    }
  ...
  const containerClasses = orientation === 'horizontal' ? 'flex items-center gap-2' : 'flex flex-col items-start gap-2'
